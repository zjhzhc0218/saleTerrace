...
<style>
    ...
    .wfbrw_div div .content_div .list_div .mission_div .mission_ul li .space_div{
        height: 0px;
        border: 0px;
    }
    .wfbrw_div div .content_div .list_div .mission_div .mission_ul li{
        font-size: 12px;
        border: 0px;
    }
    .wfbrw_div div .content_div .list_div .mission_div .mission_ul li .bb_img {
        width: 80px;
        height: 80px;
        border: 0px;
    }
    .wfbrw_div div .content_div .list_div .mission_div .mission_ul li p {
        margin-top: -10px;
    }
    .fbjl_div div .search_div{
        height: 100px;
        width: 980px;
        margin-left: 0;
        margin-top: 10;
