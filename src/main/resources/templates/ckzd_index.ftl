                ...
                <div id="zjjl_tabs" style="visibility:hidden ;" align="left">
                    ...
                    <div class="content_div">
                        <div class="tab_title">
							...
							" onclick="findSomeDateResult('TODAY')"></li>
                                    <li><input type="button" value="昨天" class="option_button date_option_s

									hide_chosen_button

							" onclick="findSomeDateResult('YESTERDAY')"></li>
							...
							" onclick="findSomeDateResult('ALL')"></li>
                                </ul>
                            </div>
                        ...
                        <ul class="jyjl_ul">
                            <li class="createTime_td wd27 pdl12 mgt5">
                                2018-10-22
                                <br>
                                <span class="minute_label">15:27</span>
                            </li>
                        ...
                        <div class="trade_info ">
                            ...
                            <ul class="trade_info_value" style="background-color: #fff">
                                ...
                                <li class="ssje_li height50" style="width: 15%;"><span class="clC0C0C0">
                                ...
                                <li class="jysj_li" style="width: 15%"><span class="clC0C0C0">
                        ...
                        <div class="trade_info ">
                            ...
                            <ul class="trade_info_value" style="background-color: #fff">
                                ...
                                <li class="xfmc_li mgt5" style="width: 25%;">
                                    <div><span class="jyh_label clC0C0C0">162036-1540193258648-225161</span></div>
                                </li>
                                <li class="height50" style="width: 15%"><span class="clC0C0C0">货款转金币-金币增加</span></li>
                                <li class="height50" style="width: 15%;"><span class="clC0C0C0">金币</span></li>
                                <li class="ssje_li height50" style="width: 15%;"><span class="clC0C0C0">
                        ...
                        <div class="trade_info ">
                            ...
                            <ul class="trade_info_value" style="background-color: #fff">
                                ...
                                <li class="xfmc_li mgt5" style="width: 25%;">
                                    <div><span class="jyh_label clC0C0C0">162036-1540193258647-590189</span></div>
                                </li>
                                <li class="height50" style="width: 15%"><span class="clC0C0C0">货款转金币-货款扣减</span></li>
                                <li class="height50" style="width: 15%;"><span class="clC0C0C0">货款</span></li>
                                <li class="ssje_li height50" style="width: 15%;"><span class="clC0C0C0">
                        ...
                        <div class="trade_info ">
                            ...
                            <ul class="trade_info_value" style="background-color: #fff">
                                ...
                                <li class="xfmc_li mgt5" style="width: 25%;">
                                    <div><span class="jyh_label clC0C0C0">162036-1540193223233-205036</span></div>
                                </li>
                                <li class="height50" style="width: 15%"><span class="clC0C0C0">金币转货款-金币扣减</span></li>
                                <li class="height50" style="width: 15%;"><span class="clC0C0C0">金币</span></li>
                                <li class="ssje_li height50" style="width: 15%;"><span class="clC0C0C0">
                        ...
                        <div class="trade_info ">
                            ...
                            <ul class="trade_info_value" style="background-color: #fff">
                                ...
                                <li class="xfmc_li mgt5" style="width: 25%;">
                                    <div><span class="jyh_label clC0C0C0">162036-1540193223235-013661</span></div>
                                </li>
                                <li class="height50" style="width: 15%"><span class="clC0C0C0">金币转货款-货款增加</span></li>
                                <li class="height50" style="width: 15%;"><span class="clC0C0C0">货款</span></li>
                                <li class="ssje_li height50" style="width: 15%;"><span class="clC0C0C0">
                        ...
                        <ul class="jyjl_ul">
                            <li class="createTime_td wd27 pdl12 mgt5">
                                2018-10-22
                                <br>
                                <span class="minute_label">15:26</span>
                            </li>
                            <li class="type_td wd28 mgt5">
                        ...
                        <div class="trade_info ">
                            ...
                            <ul class="trade_info_value" style="background-color: #fff">
                                ...
                                <li class="xfmc_li mgt5" style="width: 25%;">
                                    <div><span class="jyh_label clC0C0C0">162036-1540193193919-840311</span></div>
                                </li>
                                <li class="height50" style="width: 15%"><span class="clC0C0C0">货款转金币-货款扣减</span></li>
                                <li class="height50" style="width: 15%;"><span class="clC0C0C0">货款</span></li>
                                <li class="ssje_li height50" style="width: 15%;"><span class="clC0C0C0">
                        ...
                        <div class="trade_info ">
                            ...
                            <ul class="trade_info_value" style="background-color: #fff">
                                ...
                                <li class="xfmc_li mgt5" style="width: 25%;">
                                    <div><span class="jyh_label clC0C0C0">162036-1540193193919-361613</span></div>
                                </li>
                                <li class="height50" style="width: 15%"><span class="clC0C0C0">货款转金币-金币增加</span></li>
                                <li class="height50" style="width: 15%;"><span class="clC0C0C0">金币</span></li>
                                <li class="ssje_li height50" style="width: 15%;"><span class="clC0C0C0">
