...
<div  role="tabpanel" class="tab-pane "class="content" class="grxx_div" align="center" id="grxx_div">
    <div class="module_div jbxx_module" align="left">
        ...
        <div class="content_div">
            ...
            <span class="marginLeft">紧急联系人：{y}<span class="emergency"></span>
                <a onclick="searchLogin('myModal_phone')" class="pointer">修改</a>
            </span>
            </span>
            <br>
            <span class="marginLeft">绑定手机：{y}<span class="phoneNum"></span></span><br>
...
<!-- 								<a href="/account/zjgl_index.ftl">前去续费>></a></span> -->
    ...
    <div class="module_div rwts_module" align="left">
        ...
        <div class="content_div">
            ...
            <a href="/saleterrace/syhd_management_index?n=1" class="marginLeft number_a"  class="pointer">待接手活动（<span class="number_span waitPay">{y}</span>）
            </a>
            <a href="/saleterrace/syhd_management_index?n=3" class="marginLeft number_a" class="pointer">待发货（<span class="number_span waitSendGood">{y}</span>）
            </a>
            <a href="/saleterrace/syhd_management_index?n=5" class="marginLeft number_a" class="pointer">待返款（<span class="number_span waitBack">{y}</span>）
            </a>
            <a href="/saleterrace/syhd_management_index?n=7" class="marginLeft number_a" class="pointer">失败活动（<span class="number_span failTask">{y}</span>）
            </a>
            <div class="space_div2"></div>
        </div>
    </div>
    <div class="module_div cwqk_module" align="left">
        ...
        <div class="content_div">
            <div class="space_div"></div>
            <span class="marginLeft">货款账户<a href="/seller/seller_explain.htm?open_type=coin"><img src="/saleterrace/images/help-12-12.png"/> </a>：&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="lMoney">可用:{y}元   冻结:{y}元</span>
            ...
            <span class="lCoin">可用:{y}元   冻结:{y}元</span>
