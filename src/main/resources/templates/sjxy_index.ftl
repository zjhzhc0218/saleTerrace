...
<head>
    ...
    <script type="text/javascript" src="/saleterrace/js/vendor/datepicker/WdatePicker.js"></script>
...
<body>
    ...
    <script type="text/javascript" src="/saleterrace/js/vendor/jquery-first-event.js"></script>
            ...
            <ul class="LR_USER">
                <li class="pos-rel menu-box">
                    <a href="#" class="menu-select-icon">
                        ...
                        <p class="user-tag"  style="text-align: center; line-height:normal;"> VIP3天试用中</p></a>
                    </a>
    ...
    <div id="Content">
        <div id="Content-Left">
            ...
            <ul class="left_menu" style="margin-bottom: 10px;">
                ...
                <li>
                    <a href="/saleterrace/sjxy_index" target="_blank" style="overflow:hidden;display:block;margin:0;">
        ...
        <div id="Content-Main">
            <div class=" protocol-main">
                <div class="deal_wrap">
                    ...
                    <p class="pt20">1、本协议内容包括以下条款及本网站已经发布的或将来可能发布的各类规则。所有规则为本协议不可分割的一部分，与协议正文具有同等法律效力。本协议是您与本网站共同签订的，适用于您在本网站的全部活动。在您注册成为用户时，您已经阅读、理解并
                        接受本协议的全部条款及各类规则，并承诺遵守中国的各类法律规定，如有违反而导致任何法律后果的发生，您将以自己的名义独立承担所有相应的法律责任。
                    </p>
                    <p>2、本网站有权根据需要不时地修改本协议或根据本协议制定、修改各类具体规则并在本网站相 关系统板块发布，无需另行单独通知您。您应不时地注意本协议及具体规则的变更，若您在本协议及具体规则内容公告变更后继续使用本服务的，表示您已充分阅读、理解并接受修改后的协议和具体规则内容，也将遵循修改后的协议和具体规则使用本网站的服务；同时就您在协议和具体规则修订前通过本网站进行的交易及其
                        效力，视为您已同意并已按照本协议及有关规则进行了相应的授权和追认。若您不同意修改后的协议内容，您应停止使用本网站的服务。
                    </p>
                    <p>3、您通过自行或授权有关方根据本协议及本网站有关规则、说明操作确认本协议后，本协议即 在您和本网站之间产生法律效力。本协议不涉及您与本网站的其他用户之间因网上交易而产生的法律关系或法律纠纷，但您在此同意将全面接受和履行与本网站其他
                        用户在本网站签订的任何电子法律文本，并承诺按该等法律文本享有和/或放弃相应的权利、承担和/或豁免相应的义务。
                    </p>
                ...
                <div class="bottom_c">
                    <h1>试客多商家处罚规则</h1>
                    <table width="800px" border="0" cellpadding="0" cellspacing="1">
                        <tr>
                            <td></td>
                            <td>错误分类</td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br /> 2、禁止引导中奖的试客多用户主动
                                放弃中奖资格
                                <br /> 3、禁止引导试客多用户代拍、代刷其
                                他商品等超出试客多服务范围内的服
                                务
                                <br /> 4、禁止引导试客多用户拍活动任务商
                                品相关联的套餐
                            </td>
                            <td>
                                每人次扣除50元；
                        ...
                        <tr>
                            ...
                            <td>
                                1.禁止私下联系试客多用户强制要求
                                按商家提供的图片和文字进行评价
                                <br /> 2.禁止私下联系试客多用户强制要求
                                给予中奖商品追加评价
                                <br /> 3.商家应在试客多买家收货好评24小
                                时内确认试客评价，否则平台自动
                                审核，所产生的后果商家自行承担
                            </td>
                            <td>
                    ...
                    <ul style="list-style: none;">
                        ...
                        <li>4、以上所说的每人次，是指商家的行为所影响的用户人次（即人数），如：同一个问题，影响了到了5个买家，则视为5次违规，扣除5次费用，扣除5次分数；具体举例如下：<br>
                            举例1：商家的商品下架，导致当天有10个中奖的用户无法领奖或领奖过程受到影响，则扣除10*50=500元，对应分数扣除10次；<br>
                            举例2：商家的商品下架，活动被暂停，导致当天应该开奖10份但是无法开奖，则扣除10*50=500元，对应分数扣除10次；<br>
                            举例3：商家商品价格变动，影响了当天10个中奖用户正常下单，导致下单价格与试客多不符或者用户下单出现疑问等情况，则扣除10*50=500元，对应分数扣除10次；<br>
                            举例4：商家同一款商品，第一次上架200元，共发布10份；30天内第二次上架90元，共发布30份；导致之前中奖的10名用户的下单价格与第二次活动价格相差50%以上，则扣除10*50=500元，分出扣除10次；
                        </li>
                    </ul>
                </div>
            </div>
