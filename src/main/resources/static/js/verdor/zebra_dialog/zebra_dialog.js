        ...
        ("object" == typeof arguments[0] || "object" == typeof arguments[1]) && (options = $.extend(options, "object" == typeof arguments[0] ? arguments[0] : arguments[1])),
            plugin.init = function() {
                ...
                if (plugin.message = $("<div>", {
                    class: "ZebraDialog_Body" + (!1 !== get_type() ? " ZebraDialog_Icon ZebraDialog_" + get_type() : "")
                }),
                ...
                plugin.isIE6 && plugin.message.attr("style", "height: expression(this.scrollHeight > " + plugin.settings.max_height + ' ? "' + plugin.settings.max_height + 'px" : "85px")')),
                    plugin.settings.vcenter_short_message ? $("<div>").html(plugin.settings.message).appendTo(plugin.message) : plugin.message.html(plugin.settings.message),
                    ...
                    $.each(c, function(a, b) {
                        ...
                        $.isPlainObject(b) ? c.html(b.caption) : c.html(b),
                            c.bind("click", function() {
                                ...
                                !1 !== a && plugin.close(void 0 !== b.caption ? b.caption : b)
                            }),
                            c.appendTo(k)
                    }),
                ...
                !1 !== plugin.settings.auto_close && (plugin.dialog.bind("click", function() {
